...
| ----------------- | ---------------------- |
| [Pre-defined WFS](http://inspire.ec.europa.eu/id/ats/download-wfs/master/wfs-pre-defined) | OGC Web Service (WFS 2.0.0) |
| [Direct WFS](http://inspire.ec.europa.eu/id/ats/download-wfs/master/wfs-direct) | OGC Web Service (WFS 2.0.0) |
| [INSPIRE Quality of Service](http://inspire.ec.europa.eu/id/ats/download-wfs/master/wfs-qos) | OGC Web Service (WFS 2.0.0) |
